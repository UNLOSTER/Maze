...
public:
	...
	int to_x, to_y, x, y, room[250][250], n, m;						// 终点坐标、任务坐标、迷宫地图储存和迷宫大小
	int tot, reg[10000][10000], feg[10000][10000], flag[3][10000];	// 图节点总数、邻接矩阵、辅助邻接矩阵和迷宫中坐标与图节点编号关系记录
	bool fmap[250][250], tip[10000];								// 辅助迷宫地图、图节点是否走过记录
